...
def main(args: DictConfig):
    """
    Training / evaluation script for CFPnet
    Args:
    ...
    args.model.dim_cosovitals = dataset_collection.train_f.data['Adjustment_vitals'].shape[-1] if dataset_collection.has_vitals else 0
    ...
    if args.exp.logging:
        ...
        mlf_logger = FilteringMlFlowLogger(filter_submodels=['encoder', 'decoder','CFPnet'],
    ...
    coso_model = instantiate(args.model.CFPnet, args, dataset_collection, _recursive_=False)
